...
def generate_player(club, tier, is_youth=False):
    ...
    stats = {
        ...
        'tech_crossing': get_biased_stat(rating, archetype['statBias'].get('tech_crossing', 0)),
        'tech_heading': get_biased_stat(rating, archetype['statBias'].get('tech_heading', 0)),
        'tech_first_touch': get_biased_stat(rating, archetype['statBias'].get('tech_first_touch', 0)),
        'tech_technique': get_biased_stat(rating, archetype['statBias'].get('tech_technique', 0)),
        'tech_long_shots': get_biased_stat(rating, archetype['statBias'].get('tech_long_shots', 0)),
        ...
        'phys_jumping_reach': get_biased_stat(rating, archetype['statBias'].get('phys_jumping_reach', 0)),
        'phys_balance': get_biased_stat(rating, archetype['statBias'].get('phys_balance', 0)),
        'phys_natural_fitness': get_biased_stat(rating, archetype['statBias'].get('phys_natural_fitness', 0)),
        ...
        'ment_concentration': get_biased_stat(rating, archetype['statBias'].get('ment_concentration', 0)),
        'ment_off_the_ball': get_biased_stat(rating, archetype['statBias'].get('ment_off_the_ball', 0)),
        'ment_teamwork': get_biased_stat(60, archetype['statBias'].get('ment_teamwork', 0)),
        'ment_bravery': get_biased_stat(55, archetype['statBias'].get('ment_bravery', 0)),
        'ment_anticipation': get_biased_stat(rating, archetype['statBias'].get('ment_anticipation', 0)),
    }
