...
import { LayoutDashboard, Users, UserCog, TrendingUp, Building2, Search, GraduationCap, Settings, Newspaper, ArrowRightLeft, Briefcase, Trophy, Calendar } from 'lucide-react';
...
const Sidebar: React.FC<SidebarProps> = ({ activeTab, setActiveTab, pendingRequestsCount, pendingBidsCount }) => {
  const menuItems = [
  ...
  return (
    <div className="w-64 bg-[#121212] border-r border-white/5 flex flex-col h-screen fixed left-0 top-0 z-50">
      <div className="p-6">
